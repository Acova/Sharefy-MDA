...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="justify-content-md-center">
        <div class="form-group row justify-content-md-center">
            ...
            <div class="col-sm-2">
                <input type="text" class="form-control-plaintext" id="nameInput" runat="server"/>
            </div>
        </div>
        ...
        <div class="form-group row justify-content-md-center">
            ...
            <div class="col-sm-2">
                <input type="text" class="form-control-plaintext" id="realNameInput" runat="server"/>
            </div>
        </div>
        ...
        <div class="form-group row justify-content-md-center">
            ...
            <div class="col-sm-2">
                <input type="text" class="form-control-plaintext" id="dniInput" runat="server"/>
            </div>
        </div>
        ...
        <div class="form-group row justify-content-md-center">
            ...
            <div class="col-sm-2">
                <input type="text" class="form-control-plaintext" id="telInput" runat="server"/>
            </div>
        </div>
        ...
        <div class="form-group row justify-content-md-center">
            ...
            <div class="col-sm-2">
                <input type="text" class="form-control-plaintext" id="emailInput" runat="server"/>
            </div>
        </div>

        <div class="row justify-content-md-center mb-2">
                <div class="col-auto">
                    <asp:Button CssClass="btn btn-primary" type="button" ID="editButton" Text="Crear usuario" runat="server" OnClick="editUser"/>
                </div>
            </div>
    </div>
</asp:Content>
